<script>
    import GradientSpin from "$lib/components/GradientSpin.svelte";
</script>

<header>
    <div>
        <!-- This is importing an icon from font awesome without the overhead of all the icons -->
