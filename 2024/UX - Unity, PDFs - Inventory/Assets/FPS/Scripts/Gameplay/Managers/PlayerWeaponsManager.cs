...
namespace Unity.FPS.Gameplay
{
    ...
    public class PlayerWeaponsManager : MonoBehaviour
    {
        ...
        //-----will be made private with accessor later-----\\
        public List<WeaponController> m_WeaponSlots = new();
        ...
        void Update()
        {
            ...
            {
                //handle drop weapon
                if (m_InputHandler.GetDropWeaponButtonDown())
                { 
        ...
        public WeaponController HasWeapon(WeaponController weaponPrefab)
        {
            ...
            for (var index = 0; index < m_WeaponSlots.Count; index++)
            {
        ...
        public bool AddWeapon(WeaponController weaponPrefab)
        {
            ...
            //add an empty item onto the end of weapons list so the below code doesnt have to be completely refactored
        ...
        int GetDistanceBetweenWeaponSlots(int fromSlotIndex, int toSlotIndex, bool ascendingOrder)
        {
            ...
            {
                distanceBetweenSlots = m_WeaponSlots.Count + distanceBetweenSlots;
            }
